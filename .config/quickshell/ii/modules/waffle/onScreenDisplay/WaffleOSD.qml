...
Scope {
    ...
    property var indicators: [
        ...
        {
            id: "workspace",
            sourceUrl: "WorkspaceOSD.qml",
            globalStateValue: "osdWorkspaceOpen"
        },
    ]
    ...
    function triggerWorkspaceOSD() {
        root.currentIndicator = "workspace";
        GlobalStates.osdWorkspaceOpen = true;
    }
    ...
    Connections {
        ...
        function onOsdWorkspaceOpenChanged() {
            if (GlobalStates.osdWorkspaceOpen)
                panelLoader.active = true;
        }
    }
